!function () {
    ...
    let i = t => {
        let s = e("#header").offsetHeight, a = e(t).offsetTop;
        window.scrollTo({top: a - s, behavior: "smooth"})
    }, o = e("#navbar"), r = e("#header"), n = e("#topbar");
    if (r) {
        let c = () => {
    ...
    b && window.addEventListener("load", () => {
        b.remove()
    }), GLightbox({selector: ".glightbox"}), GLightbox({selector: ".galelry-lightbox"}), new Swiper(".testimonials-slider", {
        speed: 600,
        loop: !0,
        autoplay: {delay: 5e3, disableOnInteraction: !1},
        slidesPerView: "auto",
        pagination: {el: ".swiper-pagination", type: "bullets", clickable: !0},
        breakpoints: {320: {slidesPerView: 1, spaceBetween: 20}, 1200: {slidesPerView: 2, spaceBetween: 20}}
