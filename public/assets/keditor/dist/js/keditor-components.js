...
!function (t, o) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = o(require("KEditor"), require("jQuery"), require("CKEDITOR")); else if ("function" == typeof define && define.amd) define(["KEditor", "jQuery", "CKEDITOR"], o); else {
    ...
    return function (t) {
        ...
        i.a.components.audio = {
            settingEnabled: !0, settingTitle: "Audio Settings", init: function (t, o, e, n) {
                ...
                var n = o.find("audio"), i = n.parent(), a = t.find(".audio-autoplay"), l = t.find(".audio-controls"),
        ...
        i.a.components.form = {
            ...
            renderForm: function (t) {
                ...
                e.formRender({
                    ...
                    if (e = e.split("-"), t.attr("class")) if (t.hasClass("fb-button")) t.find("button").wrap('<div class="col-sm-'.concat(e[1], " col-sm-offset-").concat(e[0], '"></div>')); else {
                        var n = t.children("label"), i = t.children("input, select, textarea"), a = t.children("div");
            ...
            init: function (t, o, e, n) {
                var i = e.find(".keditor-component-content"), l = e.find(".form-content");
            ...
            init: function (t, o, e, n) {
                ...
                var n = this, i = t.find("#photo-align"), a = t.find("#photo-responsive"), l = t.find("#photo-width"),
        ...
        c.a.disableAutoInline = !0, c.a.dom.element.prototype.scrollIntoView = function () {
            ...
            options: {
                ...
                var i = n.options, a = e.children(".keditor-component-content");
                ...
                var e = t.find(".keditor-component-content"), n = e.attr("id"), i = c.a.instances[n];
            ...
            init: function (t, o, e, n) {
                ...
                t.find(".btn-video-input").on("click", (function (t) {
                    ...
                    var t = o.getSettingComponent().find("video"), e = "16/9" === t.attr("data-ratio") ? 16 / 9 : 4 / 3,
                        n = this.value / e;
