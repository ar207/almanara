...
function node_beautifier_tests() {
    ...
    var data = fs.readFileSync(__dirname + '/../../home-page/resources/underscore.js', 'utf8');
    var data_min = fs.readFileSync(__dirname + '/../../home-page/resources/underscore-min.js', 'utf8');
    var options = {
        wrap_line_length: 80
    };
