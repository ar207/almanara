 ...
 */
var _Mathmax = Math.max, _StringfromCharCode = String.fromCharCode, _Mathmin = Math.min, _Mathfloor = Math.floor,
    _Mathpow = Math.pow;
!function (A) {
    function t(r) {
    ...
    108: function (A, t, e) {
        ...
        t.read = function (A, t, e, r, o) {
            var n, i, s = 8 * o - r - 1, a = (1 << s) - 1, l = a >> 1, c = -7, u = e ? o - 1 : 0, g = e ? -1 : 1,
                f = A[t + u];
            ...
            var i, s, a, l = 8 * n - o - 1, c = (1 << l) - 1, u = c >> 1, g = 23 === o ? 5.960464477539062e-8 : 0,
                f = r ? 0 : n - 1, d = r ? 1 : -1, p = 0 > t || 0 === t && 0 > 1 / t ? 1 : 0;
        ...
        (function (A) {
            ...
            function l(A, t) {
                if (s(t), A = o(A, 0 > t ? 0 : 0 | d(t)), !n.TYPED_ARRAY_SUPPORT) for (var e = 0; e < t; ++e) A[e] = 0;
                return A
            }
            ...
            function E(A, t, e, r, o) {
                ...
                if (o) {
                    var c = -1;
                    for (l = e; l < s; l++) if (n(A, l) !== n(t, -1 == c ? 0 : l - c)) -1 != c && (l -= l - c), c = -1; else if (-1 == c && (c = l), l - c + 1 === a) return c * i
                } else for (e + a > s && (e = s - a), l = e; 0 <= l; l--) {
                    for (var u = !0, g = 0; g < a; g++) if (n(A, l + g) !== n(t, g)) {
                        u = !1;
                        break
                    }
                    if (u) return l
            ...
            function D(A, t, e) {
                ...
                for (var r = [], o = t; o < e;) {
                    var n = A[o], i = null, s = 239 < n ? 4 : 223 < n ? 3 : 191 < n ? 2 : 1;
                    if (o + s <= e) {
                        var a, l, c, u;
            ...
            t.Buffer = n, t.SlowBuffer = function (A) {
                ...
                if (A === t) return 0;
                for (var e = A.length, r = t.length, o = 0, i = _Mathmin(e, r); o < i; ++o) if (A[o] !== t[o]) {
                    e = A[o], r = t[o];
                    break
                }
                ...
                for (var i = o - r, s = e - t, a = _Mathmin(i, s), l = this.slice(r, o), c = A.slice(t, e), u = 0; u < a; ++u) if (l[u] !== c[u]) {
                    i = l[u], s = c[u];
                    break
                }
                ...
                if (void 0 === t) r = "utf8", e = this.length, t = 0; else if (void 0 === e && "string" == typeof t) r = t, e = this.length, t = 0; else {
            ...
            n.prototype.slice = function (A, t) {
                ...
                var r;
                if (n.TYPED_ARRAY_SUPPORT) r = this.subarray(A, t), r.__proto__ = n.prototype; else {
                    var o = t - A;
                    r = new n(o, void 0);
                ...
                var o, i = r - e;
                if (this === A && e < t && t < r) for (o = i - 1; 0 <= o; --o) A[o + t] = this[o + e]; else if (1e3 > i || !n.TYPED_ARRAY_SUPPORT) for (o = 0; o < i; ++o) A[o + t] = this[o + e]; else Uint8Array.prototype.set.call(A, this.subarray(e, e + i), t);
                return i
                ...
                var i;
                if ("number" == typeof A) for (i = t; i < e; ++i) this[i] = A; else {
                    var s = n.isBuffer(A) ? A : P(new n(A, r).toString()), a = s.length;
        ...
        function o(A) {
            for (var t = [], e = {}, r = 0; r < A.length; r++) {
                var o = A[r], n = o[0], i = o[1], s = o[2], a = o[3], l = {css: i, media: s, sourceMap: a};
                e[n] ? e[n].parts.push(l) : t.push(e[n] = {id: n, parts: [l]})
            }
            return t
        }
        ...
        function n(A, t) {
            ...
            var r = E[E.length - 1];
            if ("top" === A.insertAt) r ? r.nextSibling ? e.insertBefore(t, r.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild), E.push(t); else {
        ...
        function u(A, t, e, r) {
            ...
            if (A.styleSheet) A.styleSheet.cssText = b(t, o); else {
                var n = document.createTextNode(o), i = A.childNodes;
        ...
        function g(A, t) {
            ...
            if (r && A.setAttribute("media", r), A.styleSheet) A.styleSheet.cssText = e; else {
        ...
        function f(A, t, e) {
            var r = e.css, o = e.sourceMap, n = void 0 === t.convertToAbsoluteUrls && o;
            (t.convertToAbsoluteUrls || n) && (r = y(r)), o && (r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
            var i = new Blob([r], {type: "text/css"}), s = A.href;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var i = e(51), s = e(114), a = e(19), l = r(a), c = e(53), u = r(c), g = e(26), f = r(g), d = e(52), p = e(6),
            h = r(p), B = e(34), w = r(B), E = l.default.markup, y = function () {
                function A(t, e) {
                ...
                return A.prototype.startMoving = function (A, t) {
                    ...
                    var e = this, r = d.config.opts, o = e.d.stage, n = o.childNodes.length - 1, i = [];
                    ...
                    var t = {type: A.attr("type")}, e = $(".fld-subtype", A).val();
                    return e !== t.type && (t.subtype = e), t
                }, A.prototype.fieldOptionData = function (A) {
                    var t = [], e = $(".sortable-options li", A);
                    return e.each(function (A) {
                        var r = $(e[A]), o = $(".option-selected", r).is(":checked"),
                            n = {label: $(".option-label", r).val(), value: $(".option-value", r).val()};
                        o && (n.selected = o), t.push(n)
                    }), t
                }, A.prototype.xmlSave = function (A) {
                    var t = this.prepData(A), e = ["<form-template>\n\t<fields>"];
                    return l.default.forEach(t, function (A, t) {
                        var r = null, o = i.optionFieldsRegEx;
                        if (t.type.match(o)) {
                            for (var n = t.values, s = [], a = 0; a < n.length; a++) {
                                var l = n[a], c = E("option", l.label, l).outerHTML;
                                s.push("\n\t\t\t" + c)
                            }
                    ...
                    var t = [], e = this.d, r = this;
                    return 0 !== A.childNodes.length && l.default.forEach(A.childNodes, function (A, o) {
                        var n = $(o);
                        if (!n.hasClass("disabled-field")) {
                            var i = r.getTypes(n), s = $(".roles-field:checked", o), a = s.map(function (A) {
                                return s[A].value
                            }).get();
                            if (r.setAttrVals(o, i), i.subtype) if ("quill" === i.subtype) {
                                var c = i.name + "-preview";
                                if (window.fbEditors.quill[c]) {
                                    var u = window.fbEditors.quill[c].instance, g = u.getContents();
                    ...
                    var t = A.lastIndexOf("-"), e = parseInt(A.substring(t + 1)) + 1;
                    ...
                    var t = this, e = this.d, r = A.attr("class"), o = A[0];
                    if (-1 === r.indexOf("input-control")) {
                        var n, s = A.attr("type"), a = $(".prev-holder", o), c = {type: s};
                        t.setAttrVals(o, c);
                        ...
                        var f = w.default.lookup(c.type), d = f ? f.class : h.default.getClass(c.type, c.subtype);
                    ...
                    if (e) {
                        var r = void 0, o = t.type, n = t.style, i = e.value.split(" "),
                            s = {button: "btn", submit: "btn"}[o];
                        if (s) {
                            if (n) {
                    ...
                    var A = this, t = l.default.markup("div", null, {className: "form-builder-overlay"});
                    return document.body.appendChild(t), t.classList.add("visible"), t.onclick = function () {
                        A.closeConfirm(t)
                    }, t
                }, A.prototype.confirm = function (A, t) {
                    var e = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
                        r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : "", o = this,
                        n = f.default.current, i = o.showOverlay(),
                        s = E("button", n.yes, {className: "yes btn btn-success btn-sm"}),
                        a = E("button", n.no, {className: "no btn btn-danger btn-sm"});
                    a.onclick = function () {
                        o.closeConfirm(i)
                    }, s.onclick = function () {
                        t(), o.closeConfirm(i)
                    };
                    var l = E("div", [a, s], {className: "button-wrap"});
                    r = "form-builder-dialog " + r;
                    var c = E("div", [A, l], {className: r});
                    if (e) c.classList.add("positioned"); else {
                    ...
                    var t = this, e = A.target.id.match(/frmb-\d{13}/)[0], r = document.getElementById(e),
                        o = f.default.current, n = $("li.form-field", r), i = A.target.getBoundingClientRect(),
                    ...
                    var t = this, e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                        r = f.default.current, o = d.config.opts, n = A.querySelectorAll("li.form-field"), s = [];
                    ...
                    var t = window, e = t.sessionStorage, r = t.JSON, o = [];
                    ...
                    var A = this.d, t = $(A.controls).parent(), e = $(A.stage).parent(), r = t.width(),
                        o = A.controls.getBoundingClientRect();
                    $(window).scroll(function (n) {
                        var i = $(n.target).scrollTop(), s = {top: 5, bottom: "auto", right: "auto", left: o.left},
                            a = Object.assign({}, s, d.config.opts.stickyControls.offset);
                        if (i > e.offset().top) {
                            var l = Object.assign({position: "fixed", width: r}, a), c = t.offset(), u = e.offset(),
                                g = c.top + t.height(), f = u.top + e.height(), p = g === f && c.top > i;
                    ...
                    var A = this.data, t = l.default.escapeHtml(A.formData),
                        e = E("code", t, {className: "formData-" + d.config.opts.dataType});
                    this.dialog(E("pre", e), null, "data-dialog")
                }, A.prototype.removeField = function (A) {
                    var t = !1, e = this, r = this.d.stage, o = r.getElementsByClassName("form-field");
                    ...
                    var i = document.getElementById(A), s = $(i);
                    ...
                    var t = A.label, e = A.events, r = o(A, ["label", "events"]), n = this.data;
                    ...
                    var r = h.default.getRegisteredSubtypes(), o = {};
                    for (var n in r) if (r.hasOwnProperty(n)) {
                        for (var i = [], s = r[n], a = Array.isArray(s), l = 0, s = a ? s : s[Symbol.iterator](); ;) {
                            ...
                            var u = c, g = h.default.getClass(n, u);
                            i.push({label: g.mi18n(u), value: u})
                        }
                        o[n] = i
                    }
                    return o
                }, A.prototype.editorUI = function () {
                    var A = this.d, t = this.data;
                    A.stage = E("ul", null, {
                        id: t.formID,
                        className: "frmb"
                    }), A.controls = E("ul", null, {id: t.formID + "-control-box", className: "frmb-control"})
                }, A.prototype.processOptions = function (A) {
                    var t = this, e = A.actionButtons, r = o(A, ["actionButtons"]);
                    return e = [{
                        type: "button",
                        id: "clear",
                    ...
                    }].concat(A.actionButtons), d.config.opts = Object.assign({}, {actionButtons: e}, r), d.config.opts
                    ...
                    var A = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "js",
                        t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], e = this;
                    return {
                        js: function () {
        ...
        var r = e(330);
        "string" == typeof r && (r = [[A.i, r, ""]]), e(112)(r, {attrs: {class: "formBuilder-injected-style"}}), r.locals && (A.exports = r.locals)
    }, 147: function (A, t, e) {
        "use strict";
        ...
        e(60), e(145);
        var i = e(51), s = r(i), a = e(114), l = e(26), c = r(l), u = e(19), g = r(u), f = e(53), d = r(f), p = e(59),
            h = r(p), B = e(143), w = r(B), E = e(52), y = e(6), b = r(y);
        e(58);
        var M = e(34), I = r(M), m = (new Date).getTime(), Q = function A(t, e) {
            function r(A, t) {
                var e = [];
                for (var r in A) if (A.hasOwnProperty(r)) {
                    var n = p[r], i = A[r], s = i.value;
            ...
            var u = this, f = this, p = c.default.current, B = "frmb-" + m++, y = new a.Data(B), M = new s.default(B);
            t.layout || (t.layout = h.default);
            var Q = new t.layout(t.layoutTemplates, !0);
            b.default.controlConfig = t.controlConfig || {};
            var C = new w.default(B, Q), D = g.default.markup, v = t;
            ...
            var N = b.default.getRegistered(), j = I.default.getRegistered();
            j && $.merge(N, j), t.sortableControls && M.controls.classList.add("sort-enabled");
            for (var F = $(M.controls), T = [], R = {}, L = 0; L < N.length; L++) {
                var U = N[L], G = I.default.lookup(U), S = void 0;
                if (G) S = G.class; else if (G = {}, !(S = b.default.getClass(U)) || !S.active(U)) continue;
                var k = G.icon || S.icon(U), z = G.label || S.label(U),
            ...
            t.inputSets.length && t.inputSets.forEach(function (A, t) {
                ...
                var e = D("li", A.label, {className: "input-set-control input-set-" + t});
            ...
            var J = function (A) {
                if (A[0].classList.contains("input-set-control")) {
                    var e = [], r = t.inputSets.find(function (t) {
            ...
            var H = $(M.editorWrap),
                V = D("div", M.controls, {id: y.formID + "-cb-wrap", className: "cb-wrap " + y.layout.controls});
            if (t.showActionButtons) {
                ...
                }), Z = M.formActions = D("div", W, {className: "form-actions btn-group"});
                V.appendChild(Z)
            }
            var K = D("div", [M.stage, V], {id: y.formID + "-stage-wrap", className: "stage-wrap " + y.layout.stage});
            ...
            var _ = function () {
                var A = [], e = function (A) {
                    return g.default.markup("li", t[A], {className: "disabled-field form-" + A})
                };
                ...
                if (A instanceof jQuery) if (e.type = A[0].dataset.type, e.type) {
                    var r = I.default.lookup(e.type);
                    if (r) e = Object.assign({}, r); else {
                    ...
                    t || (e.values = A.children().map(function (A, t) {
                        return {label: $(t).text(), value: $(t).attr("value"), selected: !!$(t).attr("selected")}
                    }));
                ...
                var t = A.type, e = A.values, r = A.name,
                    o = [g.default.markup("a", p.addOption, {className: "add add-opt"})],
                    n = ['<label class="false-label">' + p.selectOptions + "</label>"],
                    i = A.multiple || "checkbox-group" === t, s = function (A) {
                        var e = {label: A, value: g.default.hyphenCase(A)};
                ...
                return n.push('<div class="sortable-options-wrap">'), n.push('<ol class="sortable-options">'), g.default.forEach(e, function (A) {
                    n.push(gA(r, e[A], i))
                }), n.push("</ol>"), n.push(g.default.markup("div", o, {className: "option-actions"}).outerHTML), n.push("</div>"), g.default.markup("div", n.join(""), {className: "form-group field-options"}).outerHTML
            }, rA = function (A) {
                ...
                var e = A.type, o = [], n = rA(e), i = {
                    required: function () {
                        return cA(A)
                    }, toggle: function () {
                        return nA("toggle", A, {first: p.toggle})
                    }, inline: function () {
                        var t = {first: p.inline, second: c.default.get("inlineDesc", e.replace("-group", ""))};
                        ...
                        var e = A.role ? 'style="display:block"' : "", r = ['<div class="available-roles" ' + e + ">"];
                        for (s in t.roles) if (t.roles.hasOwnProperty(s)) {
                            var o = "fld-" + y.lastID + "-roles-" + s,
                                n = {type: "checkbox", name: "roles[]", value: s, id: o, className: "roles-field"};
                            g.default.inArray(s, a) && (n.checked = "checked"), r.push('<label for="' + o + '">'), r.push(C.input(n).outerHTML), r.push(" " + t.roles[s] + "</label>")
                        }
                        r.push("</div>");
                        var i = {first: p.roles, second: p.limitRole, content: r.join("")};
                ...
                if ("number" === e && ["min", "max", "step"].forEach(function (t) {
                    ...
                    var t = {first: p.multipleFiles, second: p.allowMultipleFiles};
                ...
                var r = function (t) {
                    return D("label", t, {for: A + "-" + y.lastID}).outerHTML
                }, o = {type: "checkbox", className: "fld-" + A, name: A, id: A + "-" + y.lastID};
                t[A] && (o.checked = !0);
                var n = [], i = [D("input", null, o).outerHTML];
                return e.first && n.push(r(e.first)), e.second && i.push(" ", r(e.second)), e.content && i.push(e.content), i = D("div", i, {className: "input-wrap"}).outerHTML, D("div", n.concat(i), {className: "form-group " + A + "-wrap"}).outerHTML
            }, iA = function (A) {
                var t = "";
                ...
                return t += C.input({
                    ...
                    t += o
                }), t += "</div>", t = D("div", [e, t], {className: "form-group style-wrap"}), t.outerHTML
            }, sA = function (A, t) {
                var e = t[A], r = p[A] || A, o = p["placeholder." + A], n = {
                    type: "number",
                    value: e,
                    name: A,
                    min: "0",
                ...
                return D("div", ['<label for="' + n.id + '">' + r + "</label>", '<div class="input-wrap">' + i + "</div>"], {className: "form-group " + A + "-wrap"}).outerHTML
            }, aA = function (A, t, e) {
                var r = e.map(function (e, r) {
                        var o = Object.assign({label: p.option + " " + r, value: void 0}, e);
                        return e.value === t[A] && (o.selected = !0), o = g.default.trimObj(o), D("option", o.label, o)
                    }), o = {id: A + "-" + y.lastID, name: A, className: "fld-" + A + " form-control"},
                    n = p[A] || g.default.capitalize(A), i = D("label", n, {for: o.id}), s = D("select", r, o),
                    a = D("div", s, {className: "input-wrap"});
                return D("div", [i, a], {className: "form-group " + o.name + "-wrap"}).outerHTML
            }, lA = function (A, t) {
                var e = t[A] || "", r = p[A];
                "label" === A && (g.default.inArray(t.type, ["paragraph"]) ? r = p.content : e = g.default.parsedHtml(t[A]));
                var o = p["placeholder." + A] || "", n = "";
                if (![].some(function (A) {
                    return !0 === A
                })) {
                    var i = {name: A, placeholder: o, className: "fld-" + A + " form-control", id: A + "-" + y.lastID},
                        s = D("label", r, {for: i.id}).outerHTML;
                ...
                return g.default.inArray(t, ["header", "paragraph", "button"]) && e.push(!0), e.some(function (A) {
                    return !0 === A
                }) || (r = nA("required", A, {first: p.required})), r
            }, uA = function (A) {
                var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], r = A.type || "text",
                    o = A.label || p[r] || p.label, n = D("a", p.remove, {
                        id: "del_" + y.lastID,
                        className: "del-button btn delete-confirm",
                        title: p.removeMessage
                    }), i = D("a", null, {id: y.lastID + "-edit", className: "toggle-form btn icon-pencil", title: p.hide}),
                    s = D("a", null, {
                        id: y.lastID + "-copy",
                        className: "copy-button btn icon-copy",
                        title: p.copyButtonTooltip
                    }), a = D("div", [i, s, n], {className: "field-actions"}).outerHTML;
                a += D("label", g.default.parsedHtml(o), {className: "field-label"}).outerHTML;
                var l = A.required ? "display:inline" : "";
                a += D("span", " *", {className: "required-asterisk", style: l}).outerHTML;
                var c = {
                    className: "tooltip-element",
                    tooltip: A.description,
                    style: A.description ? "display:inline-block" : "display:none"
                };
                a += "<span " + g.default.attrString(c) + ">?</span>", a += D("div", "", {className: "prev-holder"}).outerHTML, a += '<div id="' + y.lastID + '-holder" class="frm-holder">', a += '<div class="form-elements">', a += oA(A), a += D("a", p.close, {className: "close-field"}).outerHTML, a += "</div>", a += "</div>";
                var u = D("li", a, {class: r + "-field form-field", type: r, id: y.lastID}), f = $(u);
                f.data("fieldData", {attrs: A}), void 0 === C.stopIndex ? Y.append(f) : $("> li", M.stage).eq(C.stopIndex).before(f), $(".sortable-options", f).sortable({
                    update: function () {
                ...
                var r = {selected: e ? "checkbox" : "radio"}, o = ["value", "label", "selected"], n = [];
                t = Object.assign({selected: !1, label: "", value: ""}, t);
                for (var i, s = o.length - 1; 0 <= s; s--) if (i = o[s], t.hasOwnProperty(i)) {
                    var a = {type: r[i] || "text", className: "option-" + i, value: t[i], name: A + "-option"};
                ...
                var e = A.attr("id"), r = A.attr("type"), o = (new Date).getTime(), n = r + "-" + o, i = A.clone();
                return $(".fld-name", i).val(n), i.find("[id]").each(function (A, t) {
                    t.id = t.id.replace(e, y.lastID)
                }), i.find("[for]").each(function (A, t) {
                    var r = t.getAttribute("for"), o = r.replace(e, y.lastID);
            ...
            if (Y.on("click touchstart", ".remove", function (A) {
                var e = $(A.target).parents(".form-field:eq(0)"), r = e[0], o = r.getAttribute("type"),
                ...
                var t = $(A.target).parents(".form-field:eq(0)"), e = $(".tooltip-element", t), r = $(A.target).val();
                ...
                A.preventDefault();
                var t = $(A.target).parent().parent("li"), e = fA(t);
                e.insertAfter(t), C.updatePreview(e), C.save.call(C)
            }), Y.on("click touchstart", ".delete-confirm", function (A) {
                A.preventDefault();
                var e = A.target.getBoundingClientRect(), r = document.body.getBoundingClientRect(),
                    o = {pageX: e.left + e.width / 2, pageY: e.top - r.top - 12},
                ...
                if (document.addEventListener("modalClosed", function () {
                    ...
                    var s = g.default.markup("h3", p.warning), a = g.default.markup("p", p.fieldRemoveWarning);
                ...
                var t = $(A.target), e = t.val(), r = t.parent().prev(".btn-style");
                ...
                var t = $(A.target).closest(".form-field").find(".available-roles"), e = $(A.target);
                t.slideToggle(250, function () {
                    e.is(":checked") || $('input[type="checkbox"]', t).removeAttr("checked")
                })
            }), Y.on("click", ".add-opt", function (A) {
                A.preventDefault();
                var t = $(A.target).closest(".field-options"), e = $('[name="multiple"]', t),
                    r = $(".option-selected:eq(0)", t), o = !1;
            ...
            return document.dispatchEvent(d.default.loaded), f.actions = {
                ...
                }, showData: C.showData.bind(C), save: C.save.bind(C), addField: function (A, t) {
        ...
        !function (A) {
            A.fn.formBuilder = function (t) {
                t || (t = {});
                var e = this, r = A.extend({}, E.defaultOptions, t, !0), n = r.i18n, i = o(r, ["i18n"]);
                E.config.opts = i;
                var s = A.extend({}, E.defaultI18n, n, !0), a = {
                    actions: {
                        getData: null,
                        setData: null,
                        save: null,
        ...
        window.fbLoaded = {js: [], css: []}, window.fbEditors = {quill: {}, tinymce: {}}, o.inArray = function (A, t) {
            ...
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "",
                r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}, n = o.contentType(t),
                i = r.events, s = e(r, ["events"]), a = document.createElement(A), l = {
                    string: function (A) {
                        a.innerHTML += A
                    }, object: function (A) {
                        var t = A.tag, r = A.content, n = e(A, ["tag", "content"]);
            ...
            var t = new window.DOMParser, e = t.parseFromString(A, "text/xml"), r = [];
            if (e) for (var n = e.getElementsByTagName("field"), i = 0; i < n.length; i++) {
                var s = o.parseAttrs(n[i]), a = n[i].getElementsByTagName("option");
            ...
            return Array.isArray(A) || (A = [A]), o.isCached(A) || (r = e.map(A, function (A) {
                return e.ajax({dataType: "script", cache: !0, url: (t || "") + A}).done(function () {
            ...
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "js", e = window.fbLoaded[t];
        ...
        A.exports = function (A) {
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
                ...
                return A.prototype.getValue = function (A) {
                    ...
                    if (t && i) if ("object" === (void 0 === t ? "undefined" : o(t))) for (var s = 0; s < i.length; s++) e = i[s].substring(1, i[s].length - 1), n = n.replace(r.makeSafe(i[s]), t[e] || ""); else n = n.replace(/\{[^\}]+?\}/g, t);
                    return n
                    ...
                    return new Promise(function (e, r) {
                        if (t.langs[A]) e(t.langs[A]); else {
                            var o = new XMLHttpRequest, n = t.config.location + A + t.config.extension;
        ...
        var s = function () {
        ...
        }(), a = e(6), l = r(a), c = e(26), u = r(c), g = function (A) {
            function t() {
            ...
            return i(t, A), t.register = function () {
                ...
                t.def || (t.def = {icon: {}, i18n: {}}), t.templates = A;
        ...
        var s = function () {
            ...
            return i(t, A), t.prototype.build = function () {
                var A = this.config, t = A.value, e = void 0 === t ? "" : t, o = r(A, ["value"]);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var r = t.instanceDom = {}, o = t.defaultSubtypes = {
                ...
                var e = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2], r = [], o = ["none", "block"];
                e && (o = o.reverse());
        ...
        t.defaultOptions = {
            ...
            typeUserEvents: {},
            prefix: "form-builder-"
        }, t.styles = {btn: ["default", "danger", "info", "primary", "success", "warning"]}, t.defaultI18n = {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var o = e(73), n = r(o), i = e(74), s = r(i), a = e(34), l = r(a), c = e(76), u = r(c), g = e(77), f = r(g),
            d = e(78), p = r(d), h = e(54), B = r(h), w = e(75), E = r(w), y = e(35), b = r(y), M = e(80), I = r(M),
            m = e(79), Q = r(m);
        t.default = {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
            ...
            function A(t, e) {
                ...
                r(this, A), this.preview = e, this.templates = {
                    ...
                    default: function (A, t, e, r) {
                        ...
                        return o.markup("div", [t, A], {className: n})
                    },
                    noLabel: function (A, t, e, r) {
                        var n = r.id ? "fb-" + r.type + " form-group field-" + r.id : "";
                        return o.markup("div", A, {className: n})
                    },
                    hidden: function (A) {
                        return A
                    }
            ...
            return A.prototype.configure = function () {
                ...
                var r = new A(t, this.preview), n = r.build();
                "object" === (void 0 === n ? "undefined" : o(n)) && n.field || (n = {field: n});
                ...
                var A = this.data.label || "", t = i.default.parsedHtml(A), e = [t];
                return this.data.required && e.push(this.markup("span", "*", {className: "fb-required"})), this.isTemplate("label") ? this.processTemplate("label", e) : this.markup("label", e, {
                    for: this.data.id,
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
        ...
        }(), a = e(19), l = r(a), c = e(26), u = r(c), g = function () {
            function A(t, e) {
            ...
            return A.register = function (t, e, r) {
                ...
                var t = {};
                for (var e in A.classRegister) if (A.classRegister.hasOwnProperty(e)) {
                    var r = e.split("."), o = r[0], n = r[1];
                    if (!n) continue;
                    t[o] || (t[o] = []), t[o].push(n)
                }
                return t
            }, A.getClass = function (t, e) {
                var r = e ? t + "." + e : t, o = A.classRegister[r] || A.classRegister[t];
                ...
                var e = this.definition, r = e.i18n || {};
                r = r[u.default.locale] || r.default || r;
                var o = this.camelCase(A), n = "object" == (void 0 === r ? "undefined" : i(r)) ? r[o] || r[A] : r;
                if (n) return n;
                var s = e.mi18n;
                ...
                var A = this.config, t = A.label, e = A.type, r = o(A, ["label", "type"]);
        ...
        (function (t, e) {
            !function (t) {
                ...
                function r(A, t, e, r) {
                    var o = Object.create((t || n).prototype), i = new d(r || []);
                ...
                function u(A, t, e) {
                    ...
                    return function (n, i) {
                        ...
                        for (; ;) {
                            ...
                            if ("next" === n) e._sent = i, e.sent = r == I ? i : B; else if ("throw" === n) {
                                if (r == M) throw r = Q, i;
                    ...
                    if (A) {
                        ...
                        if (!isNaN(A.length)) {
                            var e = -1, r = function t() {
                                for (; ++e < A.length;) if (w.call(A, e)) return t.value = A[e], t.done = !1, t;
                ...
                var B, w = Object.prototype.hasOwnProperty,
                    E = "function" == typeof Symbol && Symbol.iterator || "@@iterator", y = "object" == typeof A,
                    b = t.regeneratorRuntime;
                if (b) return void(y && (A.exports = b));
                b = t.regeneratorRuntime = y ? A.exports : {}, b.wrap = r;
                var M = "suspendedStart", I = "suspendedYield", m = "executing", Q = "completed", C = {},
                ...
                i.prototype = D.constructor = s, s.constructor = i, i.displayName = "GeneratorFunction", b.isGeneratorFunction = function (A) {
                    ...
                    constructor: d, reset: function (A) {
                        if (this.prev = 0, this.next = 0, this.sent = B, this.done = !1, this.delegate = null, this.tryEntries.forEach(f), !A) for (var t in this) "t" === t.charAt(0) && w.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = B)
                    }, stop: function () {
                        this.done = !0;
                        ...
                        for (var e = this, r = this.tryEntries.length - 1; 0 <= r; --r) {
                            ...
                            if (o.tryLoc <= this.prev) {
                                var i = w.call(o, "catchLoc"), s = w.call(o, "finallyLoc");
                                if (i && s) {
                        ...
                        for (var e, r = this.tryEntries.length - 1; 0 <= r; --r) if (e = this.tryEntries[r], e.tryLoc <= this.prev && w.call(e, "finallyLoc") && this.prev < e.finallyLoc) {
                            var o = e;
                            break
                        }
                        ...
                        for (var t, e = this.tryEntries.length - 1; 0 <= e; --e) if (t = this.tryEntries[e], t.finallyLoc === A) return this.complete(t.completion, t.afterLoc), f(t), C
                    }, catch: function (A) {
                        for (var t, e = this.tryEntries.length - 1; 0 <= e; --e) if (t = this.tryEntries[e], t.tryLoc === A) {
                            var r = t.completion;
                            if ("throw" === r.type) {
                                var o = r.arg;
                                f(t)
                        ...
                        return this.delegate = {iterator: p(A), resultName: t, nextLoc: e}, C
                    }
                }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var s = e(6), a = function (A) {
            return A && A.__esModule ? A : {default: A}
        }(s), l = e(51), c = function (A) {
            function t() {
                return o(this, t), n(this, A.apply(this, arguments))
            }

            return i(t, A), t.prototype.build = function () {
                var A = this, t = this.config, e = t.values, o = t.type, n = r(t, ["values", "type"]),
                    i = function (t) {
                        var e = t.target.nextSibling.nextSibling, r = t.target.nextSibling, o = A.getActiveOption(e),
                        ...
                        id: n.id + "-input", autocomplete: "off", events: {
                            focus: function (t) {
                                ...
                                if (0 == r.length) A.hideList(e); else {
                ...
                delete s.name;
                var c = [this.markup("input", null, s), this.markup("input", null, a)], u = e.map(function (t) {
                    var e = t.label, r = {
                        events: {
                            click: function (e) {
                                var r = e.target.parentElement, o = r.previousSibling.previousSibling;
                ...
                return c.push(this.markup("ul", u, {id: n.id + "-list", className: "fb-" + o + "-list"})), c
        ...
        var i = function () {
            ...
            return n(t, A), t.prototype.configure = function () {
                ...
                var A = $(this.wrapper), t = $(this.input), e = $.extend(!0, {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = e(6), l = r(a), c = e(19), u = r(c), g = function (A) {
            function t() {
                return n(this, t), i(this, A.apply(this, arguments))
            }

            return s(t, A), t.prototype.build = function () {
                var A = this.config, t = A.type, e = o(A, ["type"]), r = {paragraph: "p", header: this.subtype};
                return r[t] && (t = r[t]), {
                ...
                if ((u.multiple || "checkbox-group" === s) && (u.name += "[]"), "checkbox-group" === s && u.required && (this.onRender = this.groupRequired), delete u.title, o) {
                    ...
                    for (var d, p = 0; p < o.length; p++) {
                        ...
                        if (E.id = u.id + "-" + p, (!E.selected || i) && delete E.selected, void 0 !== n && E.value === n && (E.selected = !0), f) {
                            ...
                            var M = this.markup("input", null, Object.assign({}, u, E)), I = {for: E.id}, m = [M, w];
                            if (c) {
                                m = [M, this.markup("span"), w], I.className = "kc-toggle"
                            }
                            var Q = this.markup("label", m, I), C = this.markup("div", Q, {className: b});
                            t.push(C)
                        }
                    }
                    if (!f && l) {
                        ...
                        var Y = {
                            ...
                            j = this.markup("label", N, {for: x.id}), F = this.markup("div", j, {className: v});
                        t.push(F)
                    }
                }
                return "select" == s ? this.markup(g, t, u) : this.markup("div", t, {className: s})
        ...
        var s = e(35), a = function (A) {
            ...
            return i(t, A), t.prototype.configure = function () {
                ...
                var A = this.config, t = (A.value, r(A, ["value"]));
                return this.field = this.markup("div", null, t), this.field
            }, t.prototype.onRender = function () {
                var A = this.config.value || "", t = window.Quill.import("delta");
