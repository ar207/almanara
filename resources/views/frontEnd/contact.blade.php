                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" id="contact-form-container">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                {!! Form::text('contact_name',@Auth::user()->name, array('placeholder' => __('frontend.yourName'),'class' => 'form-control','id'=>'name','required'=>'required')) !!}
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                {!! Form::email('contact_email',@Auth::user()->email, array('placeholder' => __('frontend.yourEmail'),'class' => 'form-control','id'=>'email','required'=>'required')) !!}
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                {!! Form::text('contact_phone',"", array('placeholder' => __('frontend.phone'),'class' => 'form-control','id'=>'phone','required'=>'required')) !!}
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            {!! Form::text('contact_subject',"", array('placeholder' => __('frontend.subject'),'class' => 'form-control','id'=>'subject','required'=>'required')) !!}
                        </div>
                        <div class="form-group mt-3">
                            {!! Form::textarea('contact_message','', array('placeholder' => __('frontend.message'),'class' => 'form-control','id'=>'message','rows'=>'10','required'=>'required')) !!}
                        </div>
