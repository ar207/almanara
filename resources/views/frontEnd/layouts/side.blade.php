<div class="col-lg-3 col-md-5 col-sm-12 col-xs-12">
    <aside class="right-sidebar">
        <div class="mb-4">
            {{Form::open(['url'=>Helper::sectionURL($WebmasterSection->id),'method'=>'GET','class'=>'form-search'])}}
                    ...
                    <ul class="list-group">
                        @foreach($Categories as $Category)
                            ...
                            <li class="list-group-item">
                                <a href="{{ Helper::categoryURL($Category->id) }}" class="nav-link {{ $active_cat }}">
                                            <span>
                                                 @if($Category->icon !="")
                                    ...
                                    <ul class="list-group">
                                        @foreach($Category->fatherSections as $MnuCategory)
                                            ...
                                            <li class="list-group-item"><a
                                                    href="{{ Helper::categoryURL($MnuCategory->id) }}"
                                                ...
                                                @if(count($MnuCategory->fatherSections))
                                                    <ul class="list-group">
                                                        @foreach($MnuCategory->fatherSections as $MnuCategory2)
                                                            ...
                                                            ?>
                                                            <li class="list-group-item"><a
                                                                    href="{{ Helper::categoryURL($MnuCategory2->id) }}"
                                                                    class="nav-link {{ $active_cat }}">
                                            <span>
