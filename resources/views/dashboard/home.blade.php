        ...
        @if(@Auth::user()->permissionsGroup->home_status)
            ...
            @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="box p-a" style="cursor: pointer">
                                    <a href="#!">
                                        <div class="pull-left m-r">
                                            <i class="material-icons text-2x text-success m-y-sm">supervisor_account</i>
                                        </div>
                                        <div class="clear">
                                            <div class="text-muted">Total visitors</div>
                                            <h4 class="m-a-0 text-md _600">{{ $totalVisitors }}</h4>
                                        </div>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    @endphp
                    @if(!empty(count($mostVisitedProducts)))
                        <div class="col-md-12 col-xl-4" style="margin-top: 1rem;">
                            <div class="box m-b-0" style="min-height: 370px">
                                <div class="box-header">
                                    <h3>{{ __('backend.mostVisitedProducts') }}</h3>
                                </div>
                                <div class="box-tool">
                                    <ul class="nav">
                                        <li class="nav-item inline">
                                            <a href="{{ route("topicsCreate",8) }}"
                                               class="btn btn-sm white text-u-c rounded">{{ __('backend.addNew') }}</a>
                                        </li>
                                    </ul>
                                </div>
                                @if(count($mostVisitedProducts) == 0)
                                    <div class="text-center m-t-1" style="color:#bbb">
                                        <h1><i class="material-icons">&#xe7ef;</i></h1>
                                        {{ __('backend.noData') }}</div>
                                @else
                                    <ul class="list-group no-border p-b">
                                        @foreach($mostVisitedProducts as $key => $product)
                                            @php
                                            ...
                                            $editRoute = route("topicsEdit", ["webmasterId" => @$product->webmasterSection->id, "id" => $product->id]);
                                            @endphp
                                            <li class="list-group-item">
                                                <a href="{{ $editRoute }}" class="pull-left w-40 m-r">
                                                    <span class="w-40 avatar">
                                                        @if($product->photo_file!="")
                                                            <img style="height: 40px;"
                                                                 src="{{ asset('uploads/topics/'.$product->photo_file) }}"
                                                                 alt="{{ $title }}">
                                                        @endif
		                                            </span>
                                                </a>
                                                <div class="clear">
                                                    <a href="{{ $editRoute }}"
                                                       class="_500 block">{{ \Illuminate\Support\Str::limit($title, 35, '...') }}</a>
                                                    <span class="text-muted"
                                                          style="opacity: 0 !important;">Muted text</span>
                                                </div>
                                            </li>
                                        @endforeach
                    ...
                    @if(!empty(count($mostVisitedVideos)))
                        <div class="col-md-12 col-xl-4" style="margin-top: 1rem;">
                            <div class="box m-b-0" style="min-height: 370px">
                                <div class="box-header">
                                    <h3>{{ __('backend.mostVisitedVideos') }}</h3>
                                </div>
                                <div class="box-tool">
                                    <ul class="nav">
                                        <li class="nav-item inline">
                                            <a href="{{ route("topicsCreate",5) }}"
                                               class="btn btn-sm white text-u-c rounded">{{ __('backend.addNew') }}</a>
                                        </li>
                                    </ul>
                                </div>
                                @if(count($mostVisitedVideos) == 0)
                                    <div class="text-center m-t-1" style="color:#bbb">
                                        <h1><i class="material-icons">&#xe7ef;</i></h1>
                                        {{ __('backend.noData') }}</div>
                                @else
                                    <ul class="list-group no-border p-b">
                                        @foreach($mostVisitedVideos as $key => $video)
                                            @php
                                                if ($video->$title_var != "") {
                                            ...
                                            $editRoute = route("topicsEdit", ["webmasterId" => @$video->webmasterSection->id, "id" => $video->id]);
                                            @endphp
                                            <li class="list-group-item">
                                                <a href="{{ $editRoute }}" class="pull-left w-40 m-r">
                                                    <span class="w-40 avatar">
                                                        @if($video->photo_file!="")
                                                            <img style="height: 40px;"
                                                                 src="{{ asset('uploads/topics/'.$video->photo_file) }}"
                                                                 alt="{{ $title }}">
                                                        @endif
		                                            </span>
                                                </a>
                                                <div class="clear">
                                                    <a href="{{ $editRoute }}"
                                                       class="_500 block">{{ \Illuminate\Support\Str::limit($title, 35, '...') }}</a>
                                                    <span class="text-muted" style="opacity: 0;">Muted Text</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                    ...
                    @if(!empty(count($mostVisitedNews)))
                        <div class="col-md-12 col-xl-4" style="margin-top: 1rem;">
                            <div class="box m-b-0" style="min-height: 370px">
                                <div class="box-header">
                                    <h3>{{ __('backend.mostVisitedNews') }}</h3>
                                </div>
                                <div class="box-tool">
                                    <ul class="nav">
                                        <li class="nav-item inline">
                                            <a href="{{ route("topicsCreate",3) }}"
                                               class="btn btn-sm white text-u-c rounded">{{ __('backend.addNew') }}</a>
                                        </li>
                                    </ul>
                                </div>
                                @if(count($mostVisitedNews) == 0)
                                    <div class="text-center m-t-1" style="color:#bbb">
                                        <h1><i class="material-icons">&#xe7ef;</i></h1>
                                        {{ __('backend.noData') }}</div>
                                @else
                                    <ul class="list-group no-border p-b">
                                        @foreach($mostVisitedNews as $key => $news)
                                            @php
                                                if ($news->$title_var != "") {
                                            ...
                                            $editRoute = route("topicsEdit", ["webmasterId" => @$news->webmasterSection->id, "id" => $news->id]);
                                            @endphp
                                            <li class="list-group-item">
                                                <a href="{{ $editRoute }}" class="pull-left w-40 m-r">
                                                    <span class="w-40 avatar">
                                                        @if($news->photo_file!="")
                                                            <img style="height: 40px;"
                                                                 src="{{ asset('uploads/topics/'.$news->photo_file) }}"
                                                                 alt="{{ $title }}">
                                                        @endif
		                                            </span>
                                                </a>
                    ...
                    @if(Helper::GeneralWebmasterSettings("inbox_status"))
                        @if(@Auth::user()->permissionsGroup->inbox_status)
                            <div class="col-md-12 col-xl-{{$col_width}}" style="margin-top: 1rem;">
                                <div class="box m-b-0" style="min-height: 370px">
                                    <div class="box-header">
