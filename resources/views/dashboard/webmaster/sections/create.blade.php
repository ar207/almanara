            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            ...
                            <div>
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('sections_status','3',false, array('id' => 'sections_status4','class'=>'has-value')) !!}
                                    <i class="dark-white"></i>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('topic_arrangement','1', array('id' => 'topic_arrangement1','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('topic_arrangement','0', array('id' => 'topic_arrangement2','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('is_cover_photo','1', array('id' => 'is_cover_photo1','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('is_cover_photo','0', array('id' => 'is_cover_photo2','class'=>'has-value')) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
