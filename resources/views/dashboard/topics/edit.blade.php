                    ...
                    <li class="nav-item inline dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                            ...
                            <a class="dropdown-item"
                               href="{{ ((@$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6) ? route("topicView", ["webmasterId" => @$Topic->webmasterSection->id, "id" => $Topic->id]) : Helper::topicURL($Topic->id)) }}" {!! ((@$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6) ? "" : "target='_blank'") !!}><i
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                ...
                @if($WebmasterSection->extra_attach_file_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_6 }}" data-toggle="tab" data-target="#tab_files">
                    <span class="text-md"><i class="material-icons">
            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if($WebmasterSection->sections_status!=0)
                            ...
                            @else
                                {!! Form::hidden('speciality_id',$Topic->speciality_id) !!}
                            @endif
                        @else
                            ...
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('title_'.@$ActiveLanguage->code,$Topic->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','required'=>'', 'dir'=>@$ActiveLanguage->direction)) !!}
                                        </div>
                                    </div>
                                @endif
                            @endforeach
    ...
    <script>
        ...
        $("#seo_url_slug_{{ @$ActiveLanguage->code }}").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_{{ @$ActiveLanguage->code }}").text("<?php echo Helper::topicURL($Topic->id, @$ActiveLanguage->code); ?>");
            }
        });
