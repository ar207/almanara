            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{ route('specialities',$WebmasterSection->id) }}">
        ...
        <div class="box nav-active-border b-info">
            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['specialitiesUpdate',"webmasterId"=>$WebmasterSection->id,"id"=>$Sections->id],'method'=>'POST', 'files' => true])}}
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="section_mobile_photo" class="col-sm-4 box p-a-xs">
                                                ...
                                                <br>
                                                <a onclick="document.getElementById('section_mobile_photo').style.display='none';document.getElementById('mobile_photo_delete').value='1';document.getElementById('mobile_cover_undo').style.display='block';"
                                                   class="btn btn-sm btn-default">{!!  __('backend.delete') !!}</a>
                                            </div>
                                            <div id="mobile_cover_undo" class="col-sm-4 p-a-xs" style="display: none">
                                                <a onclick="document.getElementById('section_mobile_photo').style.display='block';document.getElementById('mobile_photo_delete').value='0';document.getElementById('mobile_cover_undo').style.display='none';">
                                                    <i class="material-icons">
                                                        &#xe166;</i> {!!  __('backend.undoDelete') !!}</a>
                                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                @if($Sections->thumbnail!="")
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="thumbnail_photo" class="col-sm-4 box p-a-xs">
                                                <a target="_blank"
                                                   href="{{ asset('uploads/sections/'.$Sections->thumbnail) }}"><img
                                                        src="{{ asset('uploads/sections/'.$Sections->thumbnail) }}"
                                                        class="img-responsive">
                                                    {{ $Sections->thumbnail }}
                                                </a>
                                                <br>
                                                <a onclick="document.getElementById('thumbnail_photo').style.display='none';document.getElementById('thumbnail_delete').value='1';document.getElementById('undo_thumbnail').style.display='block';"
                                                   class="btn btn-sm btn-default">{!!  __('backend.delete') !!}</a>
                                            </div>
                                            <div id="undo_thumbnail" class="col-sm-4 p-a-xs" style="display: none">
                                                <a onclick="document.getElementById('thumbnail_photo').style.display='block';document.getElementById('thumbnail_delete').value='0';document.getElementById('undo_thumbnail').style.display='none';">
                                                    <i class="material-icons">
                                                        &#xe166;</i> {!!  __('backend.undoDelete') !!}</a>
                                            </div>

                                            {!! Form::hidden('thumbnail_delete','0', array('id'=>'thumbnail_delete')) !!}
                                        </div>
                                    </div>

                                @endif
                                {!! Form::file('thumbnail', array('class' => 'form-control','id'=>'thumbnail','accept'=>'image/*')) !!}
                            </div>
                        </div>
                        ...
                        @foreach(Helper::languagesList() as $ActiveLanguage)
                            <div class="form-group row">
                                <label
                                    class="col-sm-2 form-control-label">{!!  __('backend.description') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                                </label>
                                <div class="col-sm-10">
                                    <div>
                                        {!! Form::textarea('description_'.@$ActiveLanguage->code,$Sections->{'description_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control ckeditor', 'dir'=>@$ActiveLanguage->direction)) !!}
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="form-group row m-t-md">
                            <div class="offset-sm-2 col-sm-10">
                                ...
                                <a href="{{ route('specialities',$WebmasterSection->id) }}"
                ...
                @include('dashboard.specialities.seo')
            </div>
        </div>
    </div>
@endsection
