    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                ...
                ?>
                <h3><i class="material-icons">&#xe02e;</i> {{ __('backend.specialityNew') }}</h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['specialitiesStore',$WebmasterSection->id],'method'=>'POST', 'files' => true ])}}

                @foreach(Helper::languagesList() as $ActiveLanguage)
                    @if($ActiveLanguage->box_status)
                        <div class="form-group row">
                            <label
                                class="col-sm-2 form-control-label">{!!  __('backend.specialityName') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                            </label>
                            <div class="col-sm-10">
